...
(* ****************************************************************************
   ...
   lingering, prior definitions. This is cheap safety.
...
(* ****************************************************************************
   ...
   The number of ways is the Catalan number C_3, which is five. These numbers
   increase quickly with the number of terms in an expression, but that's not
   the hazard for us. If each associativity step of a theorem has five branches,
   then our proof will have at least 5^s independent threads, where s is the
   number of associative steps. That's bad.
   ...
   axiom, one of the ways of proving theorems listed at the top of page 42.
...
(* ****************************************************************************
   ...
   This is an issue in mathics; it should produce {eqv[p], eqv[q, q, p]}; see
...
(* (3.7) Metatheorem. Any two theorems are equivalent (eqv), page 45 **********
   ...
   I N F O R M A L   P R O O F   O F   T H E   M E T A T H E O R E M
...
(* ****************************************************************************
   ...
   The last leibnizF is still ugly because it required the human to notice the
...
(* ****************************************************************************
   ...
   providing one of the inputs to each invocation. I continue to nag myself
   about this until we understand how to do better.
