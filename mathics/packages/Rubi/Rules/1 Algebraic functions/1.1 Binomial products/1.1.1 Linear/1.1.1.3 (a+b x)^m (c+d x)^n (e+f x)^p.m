...
(* ::Code:: *)
Int[(a_.+b_.*x_)*Sqrt[c_+d_.*x_]/Sqrt[e_+f_.*x_],x_Symbol] :=
...
FreeQ[{a,b,c,d,e,f,m,p},x] && EqQ[m+n+p+2,0] && GtQ[n,0] && LtQ[m,-1] && (IntegerQ[m] || IntegerQ[n] || EqQ[p,-1]) && 
  Not[IntegerQ[m] && LtQ[0,p,n]] && Not[IntegerQ[n] && LtQ[m,p,-1]] && Not[EqQ[d*e+c*f,0] && EqQ[n,p] && EqQ[a,0]]
...
FreeQ[{a,b,c,d,e,f,m,n,p},x] && EqQ[Simplify[m+n+p+3],0] && ILtQ[m,-1] && 
  Not[(GtQ[n,0] || GtQ[p,0]) && NeQ[a,0]] && (IntegersQ[2*n,2*p] || IntegerQ[n+p] || IntegersQ[p,m+n])
...
Int[(a_.+b_.*x_)^m_*(c_.+d_.*x_)^n_*(e_.+f_.*x_)^p_,x_Symbol] :=
  b*(a+b*x)^(m+1)*(c+d*x)^(n+1)*(e+f*x)^(p+1)/((m+1)*(b*c-a*d)*(b*e-a*f)) + 
  (a*d*f*(m+1)+b*c*f*(n+1)+b*d*e*(p+1))/((m+1)*(b*c-a*d)*(b*e-a*f)) \[Star] Int[(a+b*x)^(m+1)*(c+d*x)^n*(e+f*x)^p,x] /;
FreeQ[{a,b,c,d,e,f,m,n,p},x] && EqQ[Simplify[m+n+p+3],0] && Not[IntegerQ[m]] && (LtQ[m,-1] || SumSimplerQ[m,1]) && 
  Not[ILtQ[n,0]] && Not[ILtQ[p,0]] && 
  Not[(GtQ[n,0] || GtQ[p,0]) && (EqQ[a,0] || IntegerQ[p])] && (IntegersQ[2*m,2*n,2*p] || IntegersQ[p,m+n])
...
FreeQ[{a,b,c,d,e,f,p},x] && ILtQ[m,-1] && GtQ[n,0] && (IntegersQ[2*n,2*p] || IntegersQ[n+p])
...
Int[(a_.+b_.*x_)^m_*(c_.+d_.*x_)^n_*(e_.+f_.*x_)^p_,x_Symbol] :=
  ...
  1/((m+1)*(b*e-a*f)) \[Star] Int[(a+b*x)^(m+1)*(c+d*x)^(n-1)*(e+f*x)^p*
    Simp[d*e*n+c*f*(m+p+2)+d*f*(m+n+p+2)*x,x],x] /;
FreeQ[{a,b,c,d,e,f,p},x] && Not[IntegerQ[m]] && LtQ[m,-1] && GtQ[n,0] && (IntegersQ[2*m,2*n,2*p] || IntegersQ[p,m+n])
...
(* ::Code:: *)
Int[Sqrt[e_+f_.*x_]/(Sqrt[b_.*x_]*Sqrt[c_+d_.*x_]),x_Symbol] :=
  Sqrt[e+f*x]/(Sqrt[1+f*x/e]) \[Star] Int[Sqrt[1+f*x/e]/(Sqrt[b*x]*Sqrt[c+d*x]),x] /;
FreeQ[{b,c,d,e,f},x] && GtQ[c,0] && Not[GtQ[e,0]]


(* ::Code:: *)
Int[Sqrt[e_+f_.*x_]/(Sqrt[b_.*x_]*Sqrt[c_+d_.*x_]),x_Symbol] :=
  Sqrt[(c+d*x)/c]/Sqrt[c+d*x] \[Star] Int[Sqrt[e+f*x]/(Sqrt[b*x]*Sqrt[1+d*x/c]),x] /;
FreeQ[{b,c,d,e,f},x] && Not[GtQ[c,0]] && GtQ[e,0]


(* ::Code:: *)
Int[Sqrt[e_+f_.*x_]/(Sqrt[b_.*x_]*Sqrt[c_+d_.*x_]),x_Symbol] :=
  Sqrt[(c*e+d*f*x^2)/(c*e)]/(Sqrt[c+d*x]*Sqrt[e+f*x]) \[Star] Int[(e+f*x)/(Sqrt[b*x]*Sqrt[1+d*f*x^2/(c*e)]),x] /;
FreeQ[{b,c,d,e,f},x] && Not[GtQ[c,0]] && Not[GtQ[e,0]] && EqQ[d*e+c*f,0]


(* ::Code:: *)
Int[Sqrt[e_+f_.*x_]/(Sqrt[b_.*x_]*Sqrt[c_+d_.*x_]),x_Symbol] :=
  Sqrt[e+f*x]*Sqrt[1+d*x/c]/(Sqrt[c+d*x]*Sqrt[1+f*x/e]) \[Star] Int[Sqrt[1+f*x/e]/(Sqrt[b*x]*Sqrt[1+d*x/c]),x] /;
FreeQ[{b,c,d,e,f},x] && Not[GtQ[c,0] && GtQ[e,0]] && NeQ[d*e+c*f,0]


(* ::Code:: *)
(* Int[Sqrt[e_.+f_.*x_]/(Sqrt[a_+b_.*x_]*Sqrt[c_+d_.*x_]),x_Symbol] :=
  f/b \[Star] Int[Sqrt[a+b*x]/(Sqrt[c+d*x]*Sqrt[e+f*x]),x] - 
  f/b \[Star] Int[1/(Sqrt[a+b*x]*Sqrt[c+d*x]*Sqrt[e+f*x]),x] /;
...
(* ::Code:: *)
Int[1/(Sqrt[b_.*x_]*Sqrt[c_+d_.*x_]*Sqrt[e_+f_.*x_]),x_Symbol] :=
  Sqrt[1+f*x/e]/Sqrt[e+f*x] \[Star] Int[1/(Sqrt[b*x]*Sqrt[c+d*x]*Sqrt[1+f*x/e]),x] /;
FreeQ[{b,c,d,e,f},x] && GtQ[c,0] && Not[GtQ[e,0]]


(* ::Code:: *)
Int[1/(Sqrt[b_.*x_]*Sqrt[c_+d_.*x_]*Sqrt[e_+f_.*x_]),x_Symbol] :=
  Sqrt[(c*e+d*f*x^2)/(c*e)]/(Sqrt[c+d*x]*Sqrt[e+f*x]) \[Star] Int[1/(Sqrt[b*x]*Sqrt[1+d*f*x^2/(c*e)]),x] /;
FreeQ[{b,c,d,e,f},x] && Not[GtQ[c,0]] && Not[GtQ[e,0]] && EqQ[d*e+c*f,0]
...
FreeQ[{b,c,d,e,f},x] && Not[GtQ[c,0]] && Not[GtQ[e,0]] && NeQ[d*e+c*f,0]
...
(* ::Code:: *)
Int[(a_.+b_.*x_)^m_*(c_.+d_.*x_)^n_*(e_.+f_.*x_)^p_,x_Symbol] :=
  (a+b*x)^(m+1)*Simplify[(b*c-a*d)/(b*e-a*f)]^n/((m+1)*(b*e-a*f)*(e+f*x)^(m+1))*
    Hypergeometric2F1[m+1,-n,m+2,-(d*e-c*f)*(a+b*x)/((b*c-a*d)*(e+f*x))] /;
FreeQ[{a,b,c,d,e,f,m,n,p},x] && EqQ[m+n+p+2,0] && Not[IntegerQ[m]] && Not[IntegerQ[p]] && 
  (ILtQ[n,0] && (SumSimplerQ[m,1] || Not[SumSimplerQ[p,1]]) || 
   GtQ[Simplify[(b*c-a*d)/(b*e-a*f)],0] && GtQ[d*f,0] && (LtQ[c,0] && GtQ[e,0] || GtQ[c*e,0] && GtQ[Simplify[(d^2-e^2-c^2*f^2)/c],0]))


(* ::Code:: *)
Int[(a_.+b_.*x_)^m_*(c_+d_.*x_)^n_*(e_+f_.*x_)^p_,x_Symbol] :=
  (a+b*x)^(m+1)*(c+d*x)^n/((m+1)*(b*e-a*f)*(e+f*x)^(m+n+1))*((b*e-a*f)*(c+d*x)/((b*c-a*d)*(e+f*x)))^(-n)*
    Hypergeometric2F1[m+1,-n,m+2,-(d*e-c*f)*(a+b*x)/((b*c-a*d)*(e+f*x))] /;
FreeQ[{a,b,c,d,e,f,m,n,p},x] && EqQ[m+n+p+2,0] && Not[IntegerQ[m]] && Not[IntegerQ[p]] && Not[IntegerQ[n]]
...
Int[(b_.*x_)^m_*(c_+d_.*x_)^n_*(e_+f_.*x_)^p_,x_Symbol] :=
  3/b \[Star] Subst[Int[x^(3*m+2)*(c+d*x^3/b)^n*(e+f*x^3/b)^p,x],x,(b*x)^(1/3)] /;
FreeQ[{b,c,d,e,f,n,p},x] && IntegerQ[m+1/3] && IntegerQ[n+1/2] && IntegerQ[p] && (EqQ[d*e-4*c*f,0] || EqQ[d*e+8*c*f,0])


(* ::Code:: *)
Int[(a_+b_.*x_)^m_*(c_.+d_.*x_)^n_*(e_.+f_.*x_)^p_,x_Symbol] :=
  3/b \[Star] Subst[Int[x^(3*m+2)*(c-a*d/b+d*x^3/b)^n*(e-a*f/b+f*x^3/b)^p,x],x,(a+b*x)^(1/3)] /;
FreeQ[{a,b,c,d,e,f,n,p},x] && IntegerQ[m+1/3] && IntegerQ[n+1/2] && IntegerQ[p]


(* ::Code:: *)
Int[(b_.*x_)^m_*(c_.+d_.*x_)^n_*(e_.+f_.*x_)^p_,x_Symbol] :=
  c^n*e^p*(b*x)^(m+1)/(b*(m+1))*AppellF1[m+1,-n,-p,m+2,-d*x/c,-f*x/e] /;
FreeQ[{b,c,d,e,f,m,n},x] && Not[IntegerQ[m]] && Not[IntegerQ[n]] && IntegerQ[p] && GtQ[c,0] && (ConstantQ[m] || Not[ConstantQ[n]])


(* ::Code:: *)
Int[(b_.*x_)^m_*(c_+d_.*x_)^n_*(e_.+f_.*x_)^p_,x_Symbol] :=
  (d*e-c*f)^p*(c+d*x)^(n+1)/(d^(p+1)*(n+1)*(-d/(b*c))^m)*AppellF1[n+1,-m,-p,n+2,(c+d*x)/c,-f*(c+d*x)/(d*e-c*f)] /;
FreeQ[{b,c,d,e,f,m,n},x] && Not[IntegerQ[m]] && Not[IntegerQ[n]] && IntegerQ[p] && GtQ[-d/(b*c),0] && (ConstantQ[n] || Not[ConstantQ[m]])


(* ::Code:: *)
Int[(b_.*x_)^m_*(c_.+d_.*x_)^n_*(e_.+f_.*x_)^p_,x_Symbol] :=
  c^IntPart[n]*(c+d*x)^FracPart[n]/((c+d*x)/c)^FracPart[n] \[Star] Int[(b*x)^m*(1+d*x/c)^n*(e+f*x)^p,x] /;
FreeQ[{b,c,d,e,f,m,n},x] && Not[IntegerQ[m]] && Not[IntegerQ[n]] && IntegerQ[p] && Not[GtQ[c,0]] && (ConstantQ[m] || Not[ConstantQ[n]])


(* ::Code:: *)
Int[(b_.*x_)^m_*(c_.+d_.*x_)^n_*(e_.+f_.*x_)^p_,x_Symbol] :=
  (-b*c/d)^IntPart[m]*(b*x)^FracPart[m]/(-d*x/c)^FracPart[m] \[Star] Int[(-d*x/c)^m*(c+d*x)^n*(e+f*x)^p,x] /;
FreeQ[{b,c,d,e,f,m,n},x] && Not[IntegerQ[m]] && Not[IntegerQ[n]] && IntegerQ[p] && Not[GtQ[-d/(b*c),0]] && (ConstantQ[n] || Not[ConstantQ[m]])
...
FreeQ[{a,b,c,d,e,f,m,n},x] && FractionQ[m] && FractionQ[n] && IntegerQ[p] && GtQ[Simplify[b/(b*c-a*d)],0] && LeQ[Denominator[n],Denominator[m]]
...
Int[(a_+b_.*x_)^m_*(c_.+d_.*x_)^n_*(e_.+f_.*x_)^p_,x_Symbol] :=
  (b*e-a*f)^p*(a+b*x)^(m+1)/(b^(p+1)*(m+1)*Simplify[b/(b*c-a*d)]^n)*
    AppellF1[m+1,-n,-p,m+2,-d*(a+b*x)/(b*c-a*d),-f*(a+b*x)/(b*e-a*f)] /;
FreeQ[{a,b,c,d,e,f,m,n},x] && Not[IntegerQ[m]] && Not[IntegerQ[n]] && IntegerQ[p] && GtQ[Simplify[b/(b*c-a*d)],0] && (ConstantQ[m] || Not[ConstantQ[n]])


(* ::Code:: *)
Int[(a_.+b_.*x_)^m_*(c_.+d_.*x_)^n_*(e_.+f_.*x_)^p_,x_Symbol] :=
  (c+d*x)^n/(b*(c+d*x)/(b*c-a*d))^n \[Star] Int[(a+b*x)^m*Simp[b*c/(b*c-a*d)+b*d*x/(b*c-a*d),x]^n*(e+f*x)^p,x] /;
FreeQ[{a,b,c,d,e,f,m,n},x] && FractionQ[m] && FractionQ[n] && IntegerQ[p] && Not[GtQ[Simplify[b/(b*c-a*d)],0]] && LeQ[Denominator[n],Denominator[m]]


(* ::Code:: *)
Int[(a_.+b_.*x_)^m_*(c_.+d_.*x_)^n_*(e_.+f_.*x_)^p_,x_Symbol] :=
  (c+d*x)^n/(b*(c+d*x)/(b*c-a*d))^n \[Star] Int[(a+b*x)^m*Simp[b*c/(b*c-a*d)+b*d*x/(b*c-a*d),x]^n*(e+f*x)^p,x] /;
FreeQ[{a,b,c,d,e,f,m,n},x] && Not[IntegerQ[m]] && Not[IntegerQ[n]] && IntegerQ[p] && Not[GtQ[Simplify[b/(b*c-a*d)],0]] && (ConstantQ[m] || Not[ConstantQ[n]])


(* ::Code:: *)
Int[(b_.*x_)^m_*(c_+d_.*x_)^n_*(e_+f_.*x_)^p_,x_Symbol] :=
  c^n*e^p*(b*x)^(m+1)/(b*(m+1))*AppellF1[m+1,-n,-p,m+2,-d*x/c,-f*x/e] /;
FreeQ[{b,c,d,e,f,m,n,p},x] && Not[IntegerQ[m]] && Not[IntegerQ[n]] && Not[IntegerQ[p]] && GtQ[c,0] && GtQ[e,0] && 
  (ConstantQ[m] || Not[ConstantQ[n]] && Not[ConstantQ[p]])


(* ::Code:: *)
Int[(b_.*x_)^m_*(c_+d_.*x_)^n_*(e_+f_.*x_)^p_,x_Symbol] :=
  (c+d*x)^(n+1)/(d*(n+1)*(-d/(b*c))^m*(d/(d*e-c*f))^p)*AppellF1[n+1,-m,-p,n+2,(c+d*x)/c,-f*(c+d*x)/(d*e-c*f)] /;
FreeQ[{b,c,d,e,f,m,n,p},x] && Not[IntegerQ[m]] && Not[IntegerQ[n]] && Not[IntegerQ[p]] && GtQ[-d/(b*c),0] && GtQ[d/(d*e-c*f),0] && 
  (ConstantQ[n] || Not[ConstantQ[m]] && Not[ConstantQ[p]])


(* ::Code:: *)
Int[(b_.*x_)^m_*(c_+d_.*x_)^n_*(e_+f_.*x_)^p_,x_Symbol] :=
  e^IntPart[p]*(e+f*x)^FracPart[p]/((e+f*x)/e)^FracPart[p] \[Star] Int[(b*x)^m*(c+d*x)^n*(1+f*x/e)^p,x] /;
FreeQ[{b,c,d,e,f,m,n,p},x] && Not[IntegerQ[m]] && Not[IntegerQ[n]] && Not[IntegerQ[p]] && GtQ[c,0] && Not[GtQ[e,0]] && 
  (ConstantQ[m] || Not[ConstantQ[n]] && Not[ConstantQ[p]])


(* ::Code:: *)
Int[(b_.*x_)^m_*(c_+d_.*x_)^n_*(e_+f_.*x_)^p_,x_Symbol] :=
  (b*x)^m/(-d*x/c)^m \[Star] Int[(-d*x/c)^m*(c + d*x)^n*(e + f*x)^p, x] /;
FreeQ[{b,c,d,e,f,m,n,p},x] && Not[IntegerQ[m]] && Not[IntegerQ[n]] && Not[IntegerQ[p]] && Not[GtQ[-d/(b*c),0]] && GtQ[d/(d*e-c*f),0] && 
  (ConstantQ[n] || Not[ConstantQ[m]] && Not[ConstantQ[p]])


(* ::Code:: *)
Int[(b_.*x_)^m_*(c_+d_.*x_)^n_*(e_+f_.*x_)^p_,x_Symbol] :=
  (e+f*x)^p/(d*(e+f*x)/(d*e-c*f))^p \[Star] Int[(b*x)^m*(c+d*x)^n*(d*e/(d*e-c*f)+d*f*x/(d*e-c*f))^p,x] /;
FreeQ[{b,c,d,e,f,m,n,p},x] && Not[IntegerQ[m]] && Not[IntegerQ[n]] && Not[IntegerQ[p]] && GtQ[-d/(b*c),0] && Not[GtQ[d/(d*e-c*f),0]] && 
  (ConstantQ[n] || Not[ConstantQ[m]] && Not[ConstantQ[p]])


(* ::Code:: *)
Int[(b_.*x_)^m_*(c_+d_.*x_)^n_*(e_+f_.*x_)^p_,x_Symbol] :=
  c^IntPart[n]*e^IntPart[p]*(c+d*x)^FracPart[n]*(e+f*x)^FracPart[p]/(((c+d*x)/c)^FracPart[n]*((e+f*x)/e)^FracPart[p]) \[Star] 
    Int[(b*x)^m*(1+d*x/c)^n*(1+f*x/e)^p,x] /;
FreeQ[{b,c,d,e,f,m,n,p},x] && Not[IntegerQ[m]] && Not[IntegerQ[n]] && Not[IntegerQ[p]] && Not[GtQ[c,0]] && Not[GtQ[e,0]] && 
  (ConstantQ[m] || Not[ConstantQ[n]] && Not[ConstantQ[p]])


(* ::Code:: *)
Int[(b_.*x_)^m_*(c_+d_.*x_)^n_*(e_+f_.*x_)^p_,x_Symbol] :=
  (b*x)^m*(e+f*x)^p/((-d*x/c)^m*(d*(e+f*x)/(d*e-c*f))^p) \[Star] Int[(-d*x/c)^m*(c+d*x)^n*(d*e/(d*e-c*f)+d*f*x/(d*e-c*f))^p,x] /;
FreeQ[{b,c,d,e,f,m,n,p},x] && Not[IntegerQ[m]] && Not[IntegerQ[n]] && Not[IntegerQ[p]] && Not[GtQ[-d/(b*c),0]] && Not[GtQ[d/(d*e-c*f),0]] && 
  (ConstantQ[n] || Not[ConstantQ[m]] && Not[ConstantQ[p]])
...
FreeQ[{a,b,c,d,e,f,m,n,p},x] && Not[IntegerQ[m]] && Not[IntegerQ[n]] && Not[IntegerQ[p]] && GtQ[b/(b*c-a*d),0] && GtQ[b/(b*e-a*f),0] && 
  (ConstantQ[m] || Not[ConstantQ[n]] && Not[ConstantQ[p]])


(* ::Code:: *)
Int[(a_+b_.*x_)^m_*(c_+d_.*x_)^n_*(e_+f_.*x_)^p_,x_Symbol] :=
  (e+f*x)^FracPart[p]/((b/(b*e-a*f))^IntPart[p]*(b*(e+f*x)/(b*e-a*f))^FracPart[p]) \[Star] 
    Int[(a+b*x)^m*(c+d*x)^n*Simp[b*e/(b*e-a*f)+b*f*x/(b*e-a*f),x]^p,x] /;
FreeQ[{a,b,c,d,e,f,m,n,p},x] && Not[IntegerQ[m]] && Not[IntegerQ[n]] && Not[IntegerQ[p]] && GtQ[b/(b*c-a*d),0] && Not[GtQ[b/(b*e-a*f),0]] && 
  (ConstantQ[m] || Not[ConstantQ[n]] && Not[ConstantQ[p]])


(* ::Code:: *)
Int[(a_+b_.*x_)^m_*(c_+d_.*x_)^n_*(e_+f_.*x_)^p_,x_Symbol] :=
  (c+d*x)^FracPart[n]*(e+f*x)^FracPart[p]/
    ((b/(b*c-a*d))^IntPart[n]*(b/(b*e-a*f))^IntPart[p]*(b*(c+d*x)/(b*c-a*d))^FracPart[n]*(b*(e+f*x)/(b*e-a*f))^FracPart[p]) \[Star] 
    Int[(a+b*x)^m*Simp[b*c/(b*c-a*d)+b*d*x/(b*c-a*d),x]^n*Simp[b*e/(b*e-a*f)+b*f*x/(b*e-a*f),x]^p,x] /;
FreeQ[{a,b,c,d,e,f,m,n,p},x] && Not[IntegerQ[m]] && Not[IntegerQ[n]] && Not[IntegerQ[p]] && Not[GtQ[b/(b*c-a*d),0]] && Not[GtQ[b/(b*e-a*f),0]] && 
  (ConstantQ[m] || Not[ConstantQ[n]] && Not[ConstantQ[p]])
