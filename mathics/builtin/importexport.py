...
EXTENSIONMAPPINGS = {
    ...
    "*.htm" : "XHTML",
    "*.html" : "HTML",
    # "*.html" : "XHTML",  # Duplicate key - decide which one you want
    "*.ia" : "Raw",
    "*.icc" : "ICC",
    "*.icm" : "ICC",
    "*.icns" : "ICNS",
    ...
    "*.raf" : "Raw",
    "*.raw" : "Raw",
    # "*.raw" : "RawBitmap", # duplicate key - decide which you want
    "*.rdc" : "Raw",
    "*.rha" : "HarwellBoeing",
    "*.rhe" : "HarwellBoeing",
    "*.rib" : "RIB",
    ...
    "*.xls" : "XLS",
    "*.xlsx" : "XLSX",
    # "*.xml" : "ExpressionML",  # Duplicate key
    # "*.xml" : "XHTML",         # "
    # "*.xml" : "XHTMLMathML",   # "
    "*.xml" : "XML",
    "*.xyz" : "XYZ",
...
FORMATMAPPINGS = {
    ...
    # "APPLICATION/X-XLS" : "XLSX", Duplicate key decide whic we want
