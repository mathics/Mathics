...
tests1 = [
   ...
   ('Graphics[{Disk[{0,0},1]}]', '-Infinity', '"-Graphics- == -Infinity"') ,
   ('Graphics[{Disk[{0,0},1]}]', 'Sqrt[I] Infinity', '"-Graphics- == -1 ^ (1 / 4) Infinity"') ,
   ...
   ('Graphics[{Disk[{0,0},1]}]', 'TestFunction["Tengo una vaca lechera"]', '"-Graphics- == TestFunction[Tengo una vaca lechera]"') ,
   ('Graphics[{Disk[{0,0},1]}]', 'Compile[{x}, Sqrt[x]]', '"-Graphics- == CompiledFunction[{x}, Sqrt[x], -PythonizedCode-]"') ,
   ('"1 / 4"', '2 + 3 a', '"1 / 4 == 2 + 3 a"') ,
   ...
   ('TestFunction["Tengo una vaca lechera"]', '-Infinity', '"TestFunction[Tengo una vaca lechera] == -Infinity"') ,
   ('TestFunction["Tengo una vaca lechera"]', 'Sqrt[I] Infinity', '"TestFunction[Tengo una vaca lechera] == -1 ^ (1 / 4) Infinity"') ,
   ...
   ('TestFunction["Tengo una vaca lechera"]', '2.+ Pi I', '"TestFunction[Tengo una vaca lechera] == 2. + 3.14159 I"') ,
   ...
   ('Compile[{x}, Sqrt[x]]', '-Infinity', '"CompiledFunction[{x}, Sqrt[x], -PythonizedCode-] == -Infinity"') ,
   ('Compile[{x}, Sqrt[x]]', 'Sqrt[I] Infinity', '"CompiledFunction[{x}, Sqrt[x], -PythonizedCode-] == -1 ^ (1 / 4) Infinity"') ,
   ...
   ('Compile[{x}, Sqrt[x]]', '2.+ Pi I', '"CompiledFunction[{x}, Sqrt[x], -PythonizedCode-] == 2. + 3.14159 I"') ,
