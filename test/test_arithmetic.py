...
class ArithmeticTest(unittest.TestCase):
    ...
    def testAdd(self):
        cases = (
            ...
            (Expression('List', 1, 2) + Expression('List', -1, 8), Expression('List', 0, 10)))
    ...
    def testSub(self):
        cases = (
            ...
            (Integer(1) - 3, Integer(-2)),
            (Integer(1) - (-3), Integer(4)),
            (Expression('List', 1, 2) - Expression('List', -1, 8), Expression('List', 2, -6)))
        self._testCases(cases)
    ...
    def testMul(self):
        cases = (
            ...
            (Integer(3) * (-7), Integer(-21)),
            (Expression('List', 1, 2) * Expression('List', -1, 8), Expression('List', -1, 16)))
        self._testCases(cases)
    ...
    def _testCases(self, cases):
        for expression, result in cases:
            self.assertEqual(Expression('FullSimplify', expression).evaluate(self.evaluation),
